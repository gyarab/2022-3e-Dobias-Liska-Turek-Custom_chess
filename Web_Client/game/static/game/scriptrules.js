...
let ArUp = new Image();
ArUp.src = "{% static 'game/temp/arrows/arrowUp.png' %}";
let ArDown = new Image();
ArDown.src = "{% static 'game/temp/arrows/arrowDown.png' %}";
let ArLeft = new Image();
ArLeft.src = "{% static 'game/temp/arrows/arrowLeft.png' %}";
let ArRight = new Image();
ArRight.src = "{% static 'game/temp/arrows/arrowRight.png' %}";
let ArUpRight = new Image();
ArUpRight.src = "{% static 'game/temp/arrows/arrowUpRight.png' %}";
let ArUpLeft = new Image();
ArUpLeft.src = "{% static 'game/temp/arrows/arrowUpLeft.png' %}";
let ArDownRight = new Image();
ArDownRight.src = "{% static 'game/temp/arrows/arrowDownRight.png' %}";
...
document.getElementById("btn-save").addEventListener('click', function () { rules = "pawn: " + translate(pawnLoc) + "\nknight: " + translate(knightLoc) + "\nbishop: " + translate(bishopLoc) + "\nrook: " + translate(rookLoc) + "\nqueen: " + translate(queenLoc) + "\nking: " + translate(kingLoc); makeAjaxCall('mongodb+srv://UwU:MamRadTuhleDatabazi69@customchess.hmtwp1r.mongodb.net/?retryWrites=true&w=majority', rules) });
